...
WASM_SRC_FILES := $(shell find $(SRC_DIR) -maxdepth 1 -name '*.c' ! -name 'loop.c')
WASM_OBJ_FILES = $(patsubst $(SRC_DIR)/%.c,$(WASM_BUILD_DIR)/%.o,$(WASM_SRC_FILES))
WASM_FRONTEND_SRC = $(FRONTEND_DIR)/wasm.c
WASM_MAIN_SRC = $(APPS_DIR)/wasm.c
